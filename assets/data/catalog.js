...
window.WB_CATALOG = {
  ...
  "categories": [
    ...
    },
    {
      ...
      "blurb": "Desktop and browser front-ends for the hardware and services above, plus the odd standalone application.",
      "count": 4
    },
    {
      "key": "labs",
      "label": "Language Labs & Ports",
      "blurb": "Whole libraries rewritten into an unfamiliar language to find out what that language forces you to do differently \u2014 with the output checked against the original bit for bit.",
      "count": 2
    }
  ],
  "langs": [
